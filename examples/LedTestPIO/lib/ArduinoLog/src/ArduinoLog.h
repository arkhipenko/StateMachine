...
/**
   ...
   0 - ARDUINO_LOG_LEVEL_SILENT     no output
   1 - ARDUINO_LOG_LEVEL_FATAL      fatal errors
   2 - ARDUINO_LOG_LEVEL_ERROR      all errors
   3 - ARDUINO_LOG_LEVEL_WARNING    errors and warnings
   4 - ARDUINO_LOG_LEVEL_NOTICE     errors, warnings and notices
   5 - ARDUINO_LOG_LEVEL_TRACE      errors, warnings, notices, traces
   6 - ARDUINO_LOG_LEVEL_VERBOSE    all
*/
  ...
  public:
    ...
    */
    Logging()
      ...
      : _level(ARDUINO_LOG_LEVEL_SILENT),
        _showLevel(true),
        _logOutput(NULL)
#endif
    {
    ...
    */
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_FATAL
    ...
    */
    ...
    {
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_FATAL, msg, args...);
#endif
    }
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_ERROR
    ...
    */
...
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_ERROR, msg, args...);
#endif
    }
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_WARNING
    ...
    */
    ...
    {
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_WARNING, msg, args...);
#endif
    }
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_NOTICE
    ...
    */
    ...
    {
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_NOTICE, msg, args...);
#endif
    }
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_TRACE
    ...
    */
    ...
    {
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_TRACE, msg, args...);
#endif
    }
    ...
    /**
       ...
       loglevels >= ARDUINO_LOG_LEVEL_VERBOSE
    ...
    */
    ...
    {
#ifndef DISABLE_LOGGING
      printLevel(ARDUINO_LOG_LEVEL_VERBOSE, msg, args...);
#endif
    }
